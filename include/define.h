...
#define ROOT_INODE_NO 0                                                      // 文件系统根目录外存INode编号
#define INODE_NUMBERS (INODE_ZONE_SIZE* INODE_NUMBER_PER_SECTOR) // 外存INode的总个数
#define DATA_ZONE_START_SECTOR  (INODE_ZONE_START_SECTOR + INODE_ZONE_SIZE)  // 数据区的起始扇区号
#define DATA_ZONE_END_SECTOR (DISK_BLOCK_NUM - 1) // 数据区的最后扇区号
#define DATA_ZONE_SIZE (DISK_BLOCK_NUM - DATA_ZONE_START_SECTOR) // 数据区占据的扇区数量
